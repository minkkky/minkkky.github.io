...
## 사용자의 피드백과 대응
1. [`🔗블로그에 남긴 프로젝트 일기 중 (1)`](https://moist-ink.tistory.com/entry/110days)
    * 이미지 업로드가 안 되는 현상 (해결)
    * 프론트엔드에서 유효성 체크하기
        * 실패 이유를 사용자에게도 알려주기
    * 백엔드와 프론트엔드 url 정보 별도 파일로 분리하여 관리 용이성 높이기
1. [`🔗블로그에 남긴 프로젝트 일기 중 (2)`](https://moist-ink.tistory.com/entry/114days)
    * 모바일 최적화
    * 삭제 버튼 클릭 시 확인창 출력하기
    * 검색 필터링 오류 (해결)
    * XSS 공격 대응
1. [`🔗블로그에 남긴 프로젝트 일기 중 (3)`](https://moist-ink.tistory.com/entry/117days)
